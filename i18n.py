...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "log_start_url": "=== [OmniFinder] 识别为网页目标，启动全息深度嗅探: {url} ===",
        "log_start_p2p": "=== [OmniFinder] 识别为 P2P / 磁力协议，正在直链载入 ===",
        "log_start_search": "=== [OmniFinder] 识别为全网资源关键词，启动矩阵并发检索: 《{keyword}》 ===",
    ...
    "en_US": {
        "app_title": "OmniFinder - Personal Web & Media Explorer (Community Edition)",
        "omni_title": "🔍 OmniFinder Smart Hub (Auto Detection: URL Parser / Media Finder / Protocol Sniffer)",
        "omni_placeholder": "💡 Enter URL, Media Title, or Magnet Link...",
        "btn_omni": "⚡ Smart Parse / Search",
        ...
        "log_start_url": "=== [OmniFinder] URL detected, starting deep sniffer: {url} ===",
        "log_start_p2p": "=== [OmniFinder] P2P / Magnet protocol detected, loading direct stream ===",
        "log_start_search": "=== [OmniFinder] Keyword detected, starting parallel matrix search: 《{keyword}》 ===",
    ...
    "zh_TW": {
        "app_title": "萬象探索 (OmniFinder) - 個人網路多媒體與資源探索助手 (學習研究版)",
        "omni_title": "🔍 OmniFinder 極速探索（全自動智慧識別：網頁解析 / 影視搜尋 / 協議嗅探）",
        ...
        "log_start_url": "=== [OmniFinder] 識別為網頁目標，啟動全息深度嗅探: {url} ===",
        "log_start_p2p": "=== [OmniFinder] 識別為 P2P / 磁力協議，正在直鏈載入 ===",
        "log_start_search": "=== [OmniFinder] 識別為全網資源關鍵詞，啟動矩陣並發檢索: 《{keyword}》 ===",
    ...
    "ja_JP": {
        "app_title": "OmniFinder - パーソナルWeb＆メディア探索ツール (コミュニティ版)",
        "omni_title": "🔍 OmniFinder スマートハブ（自動検出：URL解析 / 動画検索 / プロトコル解析）",
        "omni_placeholder": "💡 URL、動画タイトル、またはMagnetリンクを入力...",
        "btn_omni": "⚡ 解析 / 高速検索",
        ...
        "log_start_url": "=== [OmniFinder] Webページを識別、ディープスニッフィングを開始: {url} ===",
        "log_start_p2p": "=== [OmniFinder] P2P / Magnetプロトコルを検出、直接読み込み中 ===",
        "log_start_search": "=== [OmniFinder] 検索キーワードを認識、マトリックス検索開始: 《{keyword}》 ===",
    ...
    "ko_KR": {
        "app_title": "OmniFinder - 개인용 미디어 및 리소스 탐색기 (오픈 커뮤니티 에디션)",
        "omni_title": "🔍 OmniFinder 스마트 허브 (자동 감지: URL 분석 / 미디어 검색 / 프로토콜 스니퍼)",
        "omni_placeholder": "💡 웹페이지 URL, 미디어 제목, 또는 마그넷 링크를 입력하세요...",
        "btn_omni": "⚡ 스마트 분석 / 검색",
        ...
        "log_start_url": "=== [OmniFinder] 웹 URL 감지, 심층 스니핑 시작: {url} ===",
        "log_start_p2p": "=== [OmniFinder] P2P / 마그넷 프로토콜 감지, 직링크 로드 중 ===",
        "log_start_search": "=== [OmniFinder] 키워드 감지, 매트릭스 병렬 검색 시작: 《{keyword}》 ===",
